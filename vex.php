...
<html>
    ...
    <body bgcolor="263238">
        ...
        <div class="page_header_wrapper_blank">
            <div class="page_header_wrapper">
                <div class="page_id_img">
                    <img src="assets/img/vex_static.jpg" width="100%" height="100%">
                </div>
                <div class="page_header_text_wrapper">
                    <div class="main_heading">VEX</div><br>
                    <div class="sec_heading">FOR INSPIRATION AND RECOGNITION OF SCIENCE AND TECHNOLOGY</div><br>
                    <div class="official_link">Official Websites: &nbsp; <a href="http://www.vexrobotics.com/">www.vexrobotics.com/ <i class="fa fa-external-link"></i></a> &nbsp; &nbsp; Forum:&nbsp; <a href="http://www.vexforum.com//">www.vexforum.com/ <i class="fa fa-external-link"></i></a></div>
                </div>
            </div> 
        </div>
        ...
        <div id="main_page_wrapper">
            <div class="page_info">
                <p>VEX is a fast growing international high school robotics competition. There are over 5,000 teams world wide and is growing. Students learn problem solving and improve their innovation skills through the competitions. Strict rules are applied when building the robot. Each year VEX announce a new competition that allow students to broaden their knowledge and skills.</p>
            </div>
            <div class="page_content_wrapper">
                        ...
                        <td>
                            <div class="nav_panel">
                                ...
                                <ul class='nav_btns'>
                                    ...
                                    $sqlGet = "SELECT year,val,comp_name,vex_logo FROM vex";
               ...
               vex_logo,vex_field,vex_robot,vex_other FROM vex";
                                ...
                                while($row = mysqli_fetch_array($retval))
                                {
                                    if($row["val"] == 1)
                                    {
                                        ...
                                        $img_logo  = $row['vex_logo'];
                                        $img_field = $row['vex_field'];
                                        $img_robot = $row['vex_robot'];
                                        $img_other = $row['vex_other'];
            ...
            <div class="page_content_footer">
                <div class="page_link">NAVIGATION: &nbsp; 
                    ...
                    <a href="vex.php"><i class="fa fa-angle-left"></i>VEX <i class="fa fa-angle-right"></i></a>&nbsp;
